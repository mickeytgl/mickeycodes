...
gem 'bridgetown', '~> 2.0.0.beta5' # , path: "../bridgetown" - Uncomment to use local Bridgetown source
gem 'bridgetown-builder', '~> 2.0.0.beta5'
gem 'bridgetown-core', '~> 2.0.0.beta5'
gem 'bridgetown-foundation', '~> 2.0.0.beta5'
